#!/usr/bin/env python3
"""Deep evidence/indexing pass for books 12-14 using only the canonical PDF-derived corpus.

Theme links are research aids grounded in exact corpus verses. They are not presented as an
exclusive interpretation of the Psalms or of the books.
"""
import json,re
