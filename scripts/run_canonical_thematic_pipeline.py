...
def repair_documentary_boundaries():
    ...
    import scripts.repair_known_pdf_psalm_anomalies as repair
...
def main():
    ...
    # Books 9-17: descriptive, non-exclusive indexing passes.
    run('deepen_books09_11_semantic_evidence.py')
    run('finalize_books09_11_semantic.py')
    run('deepen_books12_14_semantic_evidence.py')
    run('finalize_books12_14_semantic.py')
    run('complete_book17_thematic.py')
    run('deepen_books15_17_semantic_evidence.py')
    run('finalize_books15_17_semantic.py')

    # Books 18-20: preserve their established curated deep passes.
    ...
    run('ground_books18_20_semantic_evidence.py')
    run('finalize_book18_semantic.py'); run('finalize_book19_semantic.py'); run('finalize_book20_semantic.py')

    # Generic reconstruction of later blocks, followed immediately by their deep passes.
    ...
    run('complete_books24_26_thematic.py')
    run('complete_books27_30_thematic.py')
    run('complete_books31_40_thematic.py')
    run('complete_books41_44_thematic.py')
    ...
    for lo,hi in ((26,28),(29,31),(32,34),(35,37),(38,40),(41,43)):
        run(f'deepen_books{lo}_{hi}_semantic_evidence.py')
        run(f'finalize_books{lo}_{hi}_semantic.py')
