#!/usr/bin/env python3
"""Strict final indexing/evidence gate for books 3-5."""
import json
from collections import Counter
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];BOOKS=ROOT/'data/thematic-index/books';CORPUS=ROOT/'data/corpus/books';EXPECTED={3:range(1,24),4:range(1,25),5:range(23,48)};GENERIC=('Le psaume développe de façon répétée','Le thème «')
def finalize(book):
