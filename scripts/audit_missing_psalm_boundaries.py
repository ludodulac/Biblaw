...
def heading_match(line,case):
 s=compact(line)
 return bool(re.search(case['heading'],s,re.I) or re.match(rf'^{case["psalm"]}\s+',s))
...
for case in CASES:
 ...
 # locate nearest numbered Psalm-like headings around the target
 all_headings=[]
