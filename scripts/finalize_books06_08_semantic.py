#!/usr/bin/env python3
"""Strict final indexing/evidence gate for books 6-8."""
import json
from collections import Counter
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]; BOOKS=ROOT/'data/thematic-index/books'; CORPUS=ROOT/'data/corpus/books'
EXPECTED={6:range(25,55),7:range(24,49),8:range(25,52)}; GENERIC=('Le psaume développe de façon répétée','Le thème «')
def finalize(book):
