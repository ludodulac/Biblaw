#!/usr/bin/env python3
"""Validate documentary extraction of canonical books 21-30.
...
source = source.replace(
    ...
    'OUT = ROOT / "data/pilot/books-21-30-validation-report.json"',
)
source = source.replace(
    'for book_no in range(1,11):',
    'for book_no in range(21,31):',
)
source = source.replace(
    '"scope":"books-01-10"',
    '"scope":"books-21-30"',
...
required = [
    'books-21-30-validation-report.json',
    'range(21,31)',
    '"scope":"books-21-30"',
]
