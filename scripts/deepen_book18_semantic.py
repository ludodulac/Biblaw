...
127:{
 ...
 'themes':[
  ...
  T('eau','Eau','central','direct',[3,6,7,8,10,14,15],"L'eau représente dans le psaume le milieu relationnel et intermédiaire dans lequel circulent influences et inspirations; sa clarté conditionne la capacité à discerner ce qui dirige la vie."),
